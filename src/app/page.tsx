...
const features = [
  {
    ...
    title: "프로젝트 매칭",
    description:
      "다양한 분야의 프로젝트를 탐색하고 팀에 합류하세요. 기술 스택과 카테고리로 나에게 맞는 프로젝트를 찾을 수 있습니다.",
  },
  {
    icon: Brain,
    title: "프로젝트 관리",
    description:
      "참여한 프로젝트의 경험을 마크다운으로 기록하고, AI가 이력서에 바로 쓸 수 있도록 핵심만 정리해줍니다.",
  },
  {
    icon: FileText,
    title: "AI 이력서 작성",
    description:
      "AI 요약된 프로젝트 경험을 자동으로 불러와 이력서를 완성합니다. 기본 정보만 입력하면 바로 이력서가 만들어집니다.",
  },
];
